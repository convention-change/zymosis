	...
	jsonInfo = `
{
  ...
  "author": {
    ...
    "email": "convention-changegmppt@gmail.com",
    "url": "https://github.com/convention-change/zymosis"
  }
}
`
	jsonInfoGoStyle = `
{
  ...
  "homepage": "https://github.com/convention-change/zymosis#readme"
}
`
)
...
func TestGetPackageJsonAuthor(t *testing.T) {
	...
	assert.Equal(t, "convention-change", GetPackageJsonAuthor().Name)
	assert.Equal(t, "convention-changegmppt@gmail.com", GetPackageJsonAuthor().Email)
}
...
func TestGetPackageJsonHomepage(t *testing.T) {
	...
	InitPkgJsonContent(jsonInfoGoStyle)
	assert.Equal(t, "https://github.com/convention-change/zymosis#readme", GetPackageJsonHomepage())
}
