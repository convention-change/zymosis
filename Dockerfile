# This dockerfile uses extends image https://hub.docker.com/convention-change/zymosis
# VERSION 1
...
ARG GO_ENV_PACKAGE_NAME=github.com/convention-change/zymosis
ARG GO_ENV_ROOT_BUILD_BIN_NAME=zymosis
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/zymosis/main.go
...
ENTRYPOINT [ "/app/zymosis" ]
# CMD ["/app/zymosis", "--help"]